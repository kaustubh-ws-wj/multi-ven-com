 ...
 */
$config['tables']['users'] = 'admin_user';  
...
$config['message_start_delimiter'] = '<label class="label label-info">';  // Message start delimiter
$config['message_end_delimiter'] = '</label><br><br>';  // Message end delimiter
$config['error_start_delimiter'] = '<label class="label label-danger">';  // Error message start delimiter
$config['error_end_delimiter'] = '</label><br><br>'; // Error message end delimiter

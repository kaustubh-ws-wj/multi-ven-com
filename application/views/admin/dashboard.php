        ...
        <div class="card">
            ...
            <div class="table-responsive border rounded p-1">
                ...
                <tbody>
                    <tr>
                    <td>
                        <img class="img-sm rounded-circle" src="<?php echo ADMINASSETS; ?>images/faces/face1.jpg" alt="profile image"> Katie Holmes </td>
                    <td>$3621</td>
                    <td><img src="<?php echo ADMINASSETS; ?>images/dashboard/alipay.png" alt="alipay" class="gateway-icon mr-2"> alipay</td>
                    <td>04 Jun 2019</td>
                    <td>18 Jul 2019</td>
                    <td>
                    ...
                    <tr>
                    <td>
                        <img class="img-sm rounded-circle" src="<?php echo ADMINASSETS; ?>images/faces/face2.jpg" alt="profile image"> Minnie Copeland </td>
                    <td>$6245</td>
                    <td><img src="<?php echo ADMINASSETS; ?>images/dashboard/paypal.png" alt="alipay" class="gateway-icon mr-2"> Paypal</td>
                    <td>25 Sep 2019</td>
                    <td>07 Oct 2019</td>
                    <td>
                    ...
                    <tr>
                    <td>
                        <img class="img-sm rounded-circle" src="<?php echo ADMINASSETS; ?>images/faces/face3.jpg" alt="profile image"> Rodney Sims </td>
                    <td>$9265</td>
                    <td><img src="<?php echo ADMINASSETS; ?>images/dashboard/alipay.png" alt="alipay" class="gateway-icon mr-2"> alipay</td>
                    <td>12 dec 2019</td>
                    <td>26 Aug 2019</td>
                    ...
                    <tr>
                    <td>
                        <img class="img-sm rounded-circle" src="<?php echo ADMINASSETS; ?>images/faces/face4.jpg" alt="profile image"> Carolyn Barker </td>
                    <td>$2263</td>
                    <td><img src="<?php echo ADMINASSETS; ?>images/dashboard/alipay.png" alt="alipay" class="gateway-icon mr-2"> alipay</td>
                    <td>30 Sep 2019</td>
                    <td>20 Oct 2019</td>
    ...
    <div class="row">
        ...
        <div class="card sales-report-country">
            ...
            <div class="d-md-flex">
                ...
                <div class="mb-2 m-md-0 ml-md-auto">
                <a href="#" class="text-secondary mr-3"><i class="icon-cloud-upload mr-3"></i> Export File</a>
                <a href="#" class="text-secondary mr-3"><i class="icon-printer mr-3"></i>Print File</a>
                </div>
            </div>
        ...
        <div class="card">
            ...
            <div class="d-sm-flex align-items-center">
                ...
                <a href="#" class="btn btn-outline-info border-0 font-weight-semibold ml-auto p-0 btn-no-hover-bg">View more</a>
            </div>
            <div class="d-flex mt-4 py-3 border-bottom">
                <img class="img-sm rounded-circle" src="<?php echo ADMINASSETS; ?>images/faces/face3.jpg" alt="profile image">
                <div class="wrapper ml-2">
                <p class="mb-1 font-weight-medium">Mobile Apps Redesign</p>
                <small class="text-muted">+23 since last year</small>
                </div>
                <small class="text-muted ml-auto">10:07PM</small>
            </div>
            <div class="d-flex py-3 border-bottom">
                <img class="img-sm rounded-circle" src="<?php echo ADMINASSETS; ?>images/faces/face2.jpg">
                <div class="wrapper ml-2">
                <p class="mb-1 font-weight-medium">Inviting Join Apps Cont...</p>
                <small class="text-muted">+23 since last year</small>
                </div>
                <small class="text-muted ml-auto">01:07AM</small>
            </div>
            <div class="d-flex py-3 border-bottom">
                <img class="img-sm rounded-circle" src="<?php echo ADMINASSETS; ?>images/faces/face4.jpg" alt="profile image">
                <div class="wrapper ml-2">
                <p class="mb-1 font-weight-medium">Website Redesign</p>
                <small class="text-muted">+23 since last year</small>
                </div>
                <small class="text-muted ml-auto">04:42AM</small>
            </div>
            <div class="d-flex py-3  border-bottom">
                <img class="img-sm rounded-circle" src="<?php echo ADMINASSETS; ?>images/faces/face8.jpg">
                <div class="wrapper ml-2">
                <p class="mb-1 font-weight-medium">Analytics Dashboard</p>
                <small class="text-muted">+23 since last year</small>
                </div>
                <small class="text-muted ml-auto">07:44PM</small>
            </div>
            <div class="d-flex pt-3">
                <img class="img-sm rounded-circle" src="<?php echo ADMINASSETS; ?>images/faces/face7.jpg">
                <div class="wrapper ml-2">
                <p class="mb-1 font-weight-medium">Great Logo Design</p>
                <small class="text-muted">+23 since last year</small>
                </div>
                <small class="text-muted ml-auto">10:49AM</small>
            </div>
            </div>
        </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="card">
            ...
            <div class="row income-expense-summary-chart-text">
                ...
                <div class="input-group ml-auto" id="income-expense-summary-chart-daterange">
        ...
        <div class="card quick-status-card">
            ...
            <div class="row mt-5">
                ...
                <div class="wrapper py-4 d-flex border-bottom">
                    ...
                    <div class="ml-auto"><i class="icon-arrow-down-circle"></i><span class="text-muted ml-2">2.87 %</span></div>
                </div>

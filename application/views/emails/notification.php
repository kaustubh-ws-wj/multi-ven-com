...
<!--                <p style="Margin-bottom: 0;">Hit reply to this email and tell us which company is your dream company where you wish to get placed and why. Let us know and we will further assist you.</p>-->
                <p style="Margin-bottom: 20px;"><?php echo $userdetails['username']; ?> Has Placed Enquiry on <?php echo $userdetails['property_name']; ?> <i class="fa fa-bitcoin fa-2x" style="color:#F9A01B; font-size: 14px;"></i></p><br>
                <p style="Margin-bottom: 20px;">Click Here To Check</p>
            </div>
            ...
            <div style="Margin-left: 20px;Margin-right: 20px;">
                <div class="btn btn--flat btn--large" style="Margin-bottom: 20px;text-align: center;">
                    <![if !mso]><a style="border-radius: 4px;display: inline-block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #fff;background-color: #e45d6b;font-family: 'Open Sans', sans-serif;" href="<?= site_url() ?>/admin">Click Here!</a><![endif]>

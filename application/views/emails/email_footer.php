    ...
    <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;">
        ...
        <div class="column wide" style="text-align: left;font-size: 12px;line-height: 19px;color: #bdb9bd;font-family: Cabin,Avenir,sans-serif;Float: left;max-width: 400px;min-width: 320px; width: 320px;width: calc(8000% - 47600px);">
            <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
                <div style="Margin-left: 0px;Margin-right: 20px;Margin-bottom: 12px;">

                    <p style="Margin-top: 0;Margin-bottom: 0;">Now, let&#8217;s get started.&nbsp; All the best!</p><p style="margin-top: 17px;Margin-bottom: 0;">Regards,</p><p style="margin-top: 5px;Margin-bottom: 0;font-weight: bold;"></p><p style="margin-top: 0px;Margin-bottom: 0;font-style: italic;font-size: 13px">On behalf of Team Real Estate</p>
                </div>
                <table class="email-footer__links emb-web-links" style="border-collapse: collapse;table-layout: fixed;" role="presentation"><tbody><tr>
                            ...
                            <td class="emb-web-links" style="padding: 0;width: 26px;"><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #bdb9bd;" href="https://www.facebook.com/reslestate"><img style="border: 0;" src="https://i8.createsend1.com/static/eb/master/13-the-blueprint-3/images/facebook.png" width="26" height="26" /></a></td><td class="emb-web-links" style="padding: 0 0 0 3px;width: 26px;"><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #bdb9bd;" href="https://twitter.com/RealEstate"><img style="border: 0;" src="https://i10.createsend1.com/static/eb/master/13-the-blueprint-3/images/twitter.png" width="26" height="26" /></a></td><td class="emb-web-links" style="padding: 0 0 0 3px;width: 26px;"><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #bdb9bd;" href="https://www.linkedin.com/company/RealEstate"><img style="border: 0;" src="https://i2.createsend1.com/static/eb/master/13-the-blueprint-3/images/linkedin.png" width="26" height="26" /></a></td>
                        </tr></tbody></table>
                <div style="Margin-top: 20px;">
                    <div>RealEstate.com<br />
                       support@RealEstate.com</div>
                </div>
                <div style="Margin-top: 18px;">
                    <div>We value your suggestions, and hence, please do not hesitate to get in touch with us.</div>
                </div>
            </div>
        </div>

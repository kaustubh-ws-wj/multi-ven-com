                        ...
                        <div class="single-procuct-view">
                            ...
                            <div class="simpleLens-gallery-container" id="p-view">
                                <div class="simpleLens-container tab-content">
                                    <?php foreach($mains as $id => $row1){ ?>
                                    <div class="tab-pane <?php echo ($id == 0) ? 'active' : ''; ?>" id="p-view-<?php echo $id; ?>">
                                        <div class="simpleLens-big-image-container">
                                            <a class="simpleLens-lens-image" data-lens-image="<?php echo $mains[$id]; ?>">
                                                <img src="<?php echo $mains[$id]; ?>" class="simpleLens-big-image" alt="product">
                                            </a>
                                        </div>
                                    </div>
                                    <?php } ?>
                                    ...
                                    <div id="single-product" class="owl-carousel custom-carousel">
                                            <?php   
                                                ...
                                                foreach($thumbs as $th => $row2){ 
                                                    if($i <= 3 ){    
                                                        $thumb_html.= "<li class=\"".(($i == 1) ? 'active' : (($i == 2) ? 'last-li' : 'hidden-md hidden-xs hidden-sm'))."\"><a href=\"#p-view-".$th."\" role=\"tab\" data-toggle=\"tab\"><img style=\"height:100px;width:100px;\" src=\"".$thumbs[$th]."\" alt=\"productd\"></a></li>";
                                                    } else{
                                                        $thumb_html.= "</ul>";
                                                    }
                                                    $i++;

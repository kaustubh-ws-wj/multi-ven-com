        ...
        <div class="ps-vendor-dashboard">
            <div class="ps-section__content">
                <ul class="ps-section__links">
                    ...
                    <li ><a href="<?php echo base_url();?>vendor/sales">Sales</a></li>
                    <li class="active"><a href="<?php echo base_url();?>vendor/orders">Orders</a></li>
                            ...
                            <table >
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><a href="#"><i class="fa fa-book"></i></a></td>
                                    </tr>
                                    <tr>
                                        <td><span class="amount">18-Nov-2019</span></td>
                                        <td><a href="#">Sample Product</a></td>

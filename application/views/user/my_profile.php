        ...
        <div class="ps-vendor-dashboard">
            <div class="ps-section__content">
                <ul class="ps-section__links">
                    <li ><a href="<?php echo base_url();?>vendor/orders">My Orders</a></li>
                    <li><a href="<?php echo base_url();?>home">Invoices</a></li>
                    <li class="active"><a href="<?php echo base_url();?>home/my_profile">My Profile</a></li>
                </ul>
            </div>
        </div>
